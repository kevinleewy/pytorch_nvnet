...
class MiniNvNet(nn.Module):
    def __init__(self, config):
        super(MiniNvNet, self).__init__()
        ...
        # Encoder Blocks
        self.in_conv0 = DownSampling(inChans=self.inChans, outChans=self._c, stride=1,dropout_rate=0.2)
        #self.in_conv0 = DownSampling(inChans=self.inChans, outChans=self._c, stride=1)
        self.en_block0 = EncoderBlock(self._c, self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_down1 = DownSampling(self._c, 2 * self._c)
        self.en_block1_0 = EncoderBlock(2 * self._c, 2 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_block1_1 = EncoderBlock(2 * self._c, 2 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_down2 = DownSampling(2 * self._c, 4 * self._c)
        self.en_block2_0 = EncoderBlock(4 * self._c, 4 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_block2_1 = EncoderBlock(4 * self._c, 4 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_down3 = DownSampling(4 * self._c, 8 * self._c)
        self.en_block3_0 = EncoderBlock(8 * self._c, 8 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_block3_1 = EncoderBlock(8 * self._c, 8 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_block3_2 = EncoderBlock(8 * self._c, 8 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.en_block3_3 = EncoderBlock(8 * self._c, 8 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        
        # Decoder Blocks
        self.de_up2 =  LinearUpSampling(8 * self._c, 4 * self._c, mode=self.mode)
        self.de_block2 = DecoderBlock(4 * self._c, 4 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.de_up1 =  LinearUpSampling(4 * self._c, 2 * self._c, mode=self.mode)
        self.de_block1 = DecoderBlock(2 * self._c, 2 * self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.de_up0 =  LinearUpSampling(2 * self._c, self._c, mode=self.mode)
        self.de_block0 = DecoderBlock(self._c, self._c, activation=self.activation, normalizaiton=self.normalizaiton)
        self.de_end = OutputTransition(self._c, self.seg_outChans)
        
        # Variational Auto-Encoder
        if self.config["VAE_enable"]:
            self.dense_features = (self.input_shape[2]//16, self.input_shape[3]//16, self.input_shape[4]//16)
            self.vae = VAE(8 * self._c, outChans=self.inChans, dense_features=self.dense_features)
